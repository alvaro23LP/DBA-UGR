...
public class MapaPanel extends JPanel {
    ...
    public MapaPanel(Mapa mapa, int filaAgente, int columnaAgente, int filaMeta, int columnaMeta) {
        ...
        //Cargar las imágenes
        try {
            pacmanImagen = ImageIO.read(new File("src/practica2/GUI/images/pacman2.png"));
            cerezaImagen = ImageIO.read(new File("src/practica2/GUI/images/cerezas.png"));
            fantasmas[0] = ImageIO.read(new File("src/practica2/GUI/images/fantasma_rojo.png"));
            fantasmas[1] = ImageIO.read(new File("src/practica2/GUI/images/fantasma_azul.png"));
            fantasmas[2] = ImageIO.read(new File("src/practica2/GUI/images/fantasma_rosa.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
